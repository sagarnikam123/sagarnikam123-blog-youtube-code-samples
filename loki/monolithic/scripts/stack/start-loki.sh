...
LOKI_CONFIG="v3.x/v3.5.x/loki-3.5.x-minimal-official-github.yaml"

# Available options:
# v2.x/loki-2.x-prod-local-storage.yaml
# v2.x/loki-2.x-prod-s3-memberlist.yaml
# v3.x/v3.5.x/loki-3.x-dev-local-storage.yaml
# v3.x/v3.5.x/loki-3.x-prod-s3-storage.yaml
# v3.x/v3.5.x/loki-3.x-most-rings-enabled.yaml
# v3.x/v3.5.x/loki-3.x-minimal-working.yaml
# v3.x/v3.5.x/loki-3.x-simple-working.yaml
