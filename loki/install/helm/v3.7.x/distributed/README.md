# Loki Distributed (Microservices) Mode - v3.7.x
...
```bash
# From base directory: loki/install/helm/v3.7.x/
...
loki:
  image:
    tag: "3.7.3"  # Specific Loki version
```
